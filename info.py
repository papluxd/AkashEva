...
BOT_TOKEN = environ.get('BOT_TOKEN', "5855144587:AAFEZtXTHtbqAkffROOHuMA492nOzXvC3W4")
...
CUSTOM_FILE_CAPTION = environ.get("<code>{file_name}</code> 𝐉𝐨𝐢𝐧 ɴᴏᴡ: [movies ok](https://t.me/Trickyakash5213)</b>", None)
